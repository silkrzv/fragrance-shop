document.addEventListener("DOMContentLoaded", () => {
    ...
    return `
      <article class="parfum-item" data-id="${product.id}">
        ...
        <div class="parfum-img-container">
          <img class="parfum-img" src="../images/${product.image_url}" alt="${
      product.name
    }">
        </div>
        ...
        <p class="parfum-type"><strong><i class="fa-solid fa-mars"></i> Tip:</strong> ${
          product.type
        }</p>
  ...
  // 3. Event pentru adaugare in cos cu AJAX (localStorage)
  ...
  // 4. Functie pentru adaugare in cos (localStorage)
